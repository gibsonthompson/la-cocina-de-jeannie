    ...
    <footer className="bg-navy-deep text-cream">
      <div className="shell grid gap-12 py-20 md:grid-cols-[1.3fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-6 max-w-xs font-body text-sm leading-relaxed text-cream/70">
            Catering for the moments that matter, across North Georgia.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 font-body text-sm text-cream/75">
            ...
            <li><Link href="/quote" className="link-ed hover:text-gold">Inquire</Link></li>
          </ul>
        </div>
      ...
      <div className="border-t border-cream/10">
        <div className="shell flex flex-col gap-2 py-7 font-body text-xs text-cream/45 sm:flex-row sm:items-center sm:justify-between">
          <span>&copy; {new Date().getFullYear()} Jeannie &amp; Co. &middot; North Georgia</span>
